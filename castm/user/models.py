...
class Consignment(models.Model):
    ...
    airway_bill_number = models.CharField('Airway Bill #', max_length=64, blank=True)
    airport_originating = models.CharField("Airport Originating", max_length=3, blank=True)
    airport_destination = models.CharField("Airport Destination", max_length=3, blank=True)
