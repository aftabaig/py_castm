...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Consignment.eta_date'
        db.add_column(u'api_consignment', 'eta_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 10, 18, 0, 0), auto_now=True, auto_now_add=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Consignment.eta_date'
        db.delete_column(u'api_consignment', 'eta_date')
