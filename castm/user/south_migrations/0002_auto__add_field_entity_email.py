...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entity.email'
        db.add_column(u'api_entity', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entity.email'
        db.delete_column(u'api_entity', 'email')
