...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Consignment.deliveryAddress'
        db.delete_column(u'api_consignment', 'deliveryAddress')


    def backwards(self, orm):
        # Adding field 'Consignment.deliveryAddress'
        db.add_column(u'api_consignment', 'deliveryAddress',
