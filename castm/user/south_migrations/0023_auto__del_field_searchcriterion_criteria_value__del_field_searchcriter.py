...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SearchCriterion.criteria'
        db.delete_column(u'api_searchcriterion', 'criteria')

        # Adding field 'SearchCriterion.criterion'
        db.add_column(u'api_searchcriterion', 'criterion',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'SearchCriterion.criterion_value'
        db.add_column(u'api_searchcriterion', 'criterion_value',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'SearchCriterion.criteria'
        db.add_column(u'api_searchcriterion', 'criteria',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Deleting field 'SearchCriterion.criterion'
        db.delete_column(u'api_searchcriterion', 'criterion')

        # Deleting field 'SearchCriterion.criterion_value'
        db.delete_column(u'api_searchcriterion', 'criterion_value')
    ...
    models = {
        ...
        u'api.searchcriterion': {
            ...
            'criterion': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'criterion_value': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
