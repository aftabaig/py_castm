...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Consignment.customer_reference'
        db.add_column(u'api_consignment', 'customer_reference',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Consignment.customer_reference'
        db.delete_column(u'api_consignment', 'customer_reference')
