...
class Event(models.Model):
    ...
    audition_start_date = models.CharField("Audition Start Date", max_length=64, blank=True, null=True)
    audition_end_date = models.CharField("Audition End Date", max_length=64, blank=True, null=True)
    audition_time_from = models.CharField("Audition Time From", max_length=64, blank=True, null=True)
    audition_time_to = models.CharField("Audition Time To", max_length=64, blank=True, null=True)
    callback_start_date = models.CharField("Callback Start Date", max_length=64, blank=True, null=True)
    callback_end_date = models.CharField("Callback End Date", max_length=64, blank=True, null=True)
    callback_time_from = models.CharField("Callback Time From", max_length=64, blank=True, null=True)
    callback_time_to = models.CharField("Callback Time To", max_length=64, blank=True, null=True)
