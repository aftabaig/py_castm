...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Consignment.originator'
        db.add_column(u'api_consignment', 'originator',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='consignment_originator', to=orm['api.Entity']),
                      keep_default=False)

        # Adding field 'Consignment.originator_account'
        db.add_column(u'api_consignment', 'originator_account',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['api.EntityAccount']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Consignment.originator'
        db.delete_column(u'api_consignment', 'originator_id')

        # Deleting field 'Consignment.originator_account'
        db.delete_column(u'api_consignment', 'originator_account_id')
    ...
    models = {
        u'api.consignment': {
            ...
            'eta_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 18, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'originator_account': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'to': u"orm['api.EntityAccount']"}),
