...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SearchCriteria.value'
        db.add_column(u'api_searchcriteria', 'value',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Deleting field 'SearchField.field'
        db.delete_column(u'api_searchfield', 'field')

        # Deleting field 'SearchField.value'
        db.delete_column(u'api_searchfield', 'value')

        # Adding field 'SearchField.name'
        db.add_column(u'api_searchfield', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'SearchField.title'
        db.add_column(u'api_searchfield', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SearchCriteria.value'
        db.delete_column(u'api_searchcriteria', 'value')

        # Adding field 'SearchField.field'
        db.add_column(u'api_searchfield', 'field',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'SearchField.value'
        db.add_column(u'api_searchfield', 'value',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Deleting field 'SearchField.name'
        db.delete_column(u'api_searchfield', 'name')

        # Deleting field 'SearchField.title'
        db.delete_column(u'api_searchfield', 'title')
    ...
    models = {
        ...
        u'api.searchcriteria': {
            'Meta': {'object_name': 'SearchCriteria'},
