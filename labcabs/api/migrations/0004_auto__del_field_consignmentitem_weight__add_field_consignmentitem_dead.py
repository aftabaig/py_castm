...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ConsignmentItem.weight'
        db.delete_column(u'api_consignmentitem', 'weight')

        # Adding field 'ConsignmentItem.dead_weight'
        db.add_column(u'api_consignmentitem', 'dead_weight',
    ...
    def backwards(self, orm):
        # Adding field 'ConsignmentItem.weight'
        db.add_column(u'api_consignmentitem', 'weight',
                      self.gf('django.db.models.fields.CharField')(default='0', max_length=16),
                      keep_default=False)

        # Deleting field 'ConsignmentItem.dead_weight'
        db.delete_column(u'api_consignmentitem', 'dead_weight')
    ...
    models = {
        ...
        u'api.consignmentitem': {
            ...
            'chargeable_weight': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
            ...
            'volumetric_weight': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
